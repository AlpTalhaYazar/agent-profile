/**
 * In-memory mock backend for CLI tests.
 *
 ...
 * system.
 *
 * This is a local copy of the MockBackend from `@agent-profile/secrets/test`,
 * kept here so CLI tests can import it without reaching into the secrets
 * package's test directory (which is not part of its dist).
 */
